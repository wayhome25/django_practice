...
class IndexView(ListView):
    template_name = 'polls_cbv/index.html' # default: <app_label>/<model_name>_list.html
    model = Question
...
class DetailView(DetailView):
    template_name = 'polls_cbv/detail.html' # Default: <app_label>/<model_name>_detail.html
    model = Question
    context_object_name = 'question' # Default: object
